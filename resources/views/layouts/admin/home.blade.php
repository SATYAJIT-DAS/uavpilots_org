                    ...
                    <td>
                      <div class="avatar-group ">
                        <a href="#" class="avatar ajax w-32" data-toggle="tooltip" title="Libero">
                          <img src="{{ asset('basik_img/img/a3.jpg' ) }}" alt=".">
                        </a>
