...
//         cacheBust: false,
//         elements: "#header .navbar-navss a:not(.no-ajax)",
...
//         cacheBust: false,
//         elements:
//             "#asides a:not(.no-ajax), #content a.ajax, #header a:not(.no-ajax), #sidebar a:not(.no-ajax)",
