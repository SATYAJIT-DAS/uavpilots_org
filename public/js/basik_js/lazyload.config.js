...
var MODULE_CONFIG = {
    chat: [
        ...
        "../js/basik_js/app/chat.js"
    ],
    mail: [
        "../libs/list.js/dist/list.js",
        "../libs/notie/dist/notie.min.js",
        "../js/basik_js/plugins/notie.js",
        "../js/basik_js/app/mail.js"
    ],
    user: [
        "../libs/list.js/dist/list.js",
        "../libs/notie/dist/notie.min.js",
        "../js/basik_js/plugins/notie.js",
        "../js/basik_js/app/user.js"
    ],
    search: ["../libs/list.js/dist/list.js", "../js/basik_js/app/search.js"],
    invoice: [
        "../libs/list.js/dist/list.js",
        "../libs/notie/dist/notie.min.js",
        "../js/basik_js/app/invoice.js"
    ],
    musicapp: [
        "../libs/list.js/dist/list.js",
        "../js/basik_js/plugins/musicapp.js"
    ],
    fullscreen: [
        "../libs/jquery-fullscreen-plugin/jquery.fullscreen-min.js",
        "../js/basik_js/plugins/fullscreen.js"
    ],
    ...
    stellar: [
        ...
        "../js/basik_js/plugins/stellar.js"
    ],
    ...
    chartist: [
        ...
        "../js/basik_js/plugins/chartist.js"
    ],
    dataTable: [
        ...
        "../js/basik_js/plugins/datatable.js"
    ],
    bootstrapTable: [
        ...
        "../js/basik_js/plugins/tableExport.min.js",
        "../js/basik_js/plugins/bootstrap-table.js"
    ],
    bootstrapWizard: [
    ...
    typeahead: [
        ...
        "../js/basik_js/plugins/typeahead.js"
    ],
    datepicker: [
    ...
    select2: [
        ...
        "../js/basik_js/plugins/select2.js"
    ],
    summernote: [
