(function($) {
    ...
    $(document).on("click", "[data-nav] a", function(e) {
        ...
        ($this.next().is("ul") && $li.toggleClass("active")) ||
            $li.addClass("active");
    ...
    function setTheme() {
        var that = $(".setting"),
            ...
            aside = $("#aside");
        // bg
        body.removeClass(body.attr("data-class"))
        ...
        that.find('input[name="foldedAside"]').prop(
            "checked",
            theme.setting.foldedAside
        );
        that.find('input[name="hideAside"]').prop(
            "checked",
            theme.setting.hideAside
        );
        that.find('input[name="stickyHeader"]').prop(
            "checked",
            theme.setting.stickyHeader
        );
        that.find('input[name="stickyAside"]').prop(
            "checked",
            theme.setting.stickyAside
        );

        that.find('input[name="bg"][value="' + theme.setting.bg + '"]').prop(
            "checked",
            true
        );
    }
