...
__webpack_require__(/*! ./industryDatatable */ "./resources/js/industryDatatable.js");
...
$(function () {
  $(".user-data").DataTable({
    ...
    initComplete: function initComplete() {
      var column = this.api().column(1);
      $('<label class="m-2">Filter:</label>').appendTo($("#DataTables_Table_0_length"));
      var select = $('<select class="m-2 custom-select custom-select-sm form-control form-control-sm"><option value="">Industry</option></select>').appendTo($("#DataTables_Table_0_length")).on("change", function () {
        var val = $.fn.dataTable.util.escapeRegex($(this).val());
        column.search(val ? "^" + val + "$" : "", true, false).draw();
      });
      column.data().unique().sort(function (d, j) {
...
/***/ "./resources/js/industryDatatable.js":
/*!*******************************************!*\
  !*** ./resources/js/industryDatatable.js ***!
  \*******************************************/
/*! no static exports found */
...
__webpack_require__(/*! /home/farabi/uavpilots_org/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/farabi/uavpilots_org/resources/sass/app.scss */"./resources/sass/app.scss");
